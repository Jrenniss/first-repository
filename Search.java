/**
Name: Search
Description: - Program that implements a multidimensional array based on given data set
			 - Prompt user for a search term
			 - Display matching results of search along witht the count of the number of matches found.
